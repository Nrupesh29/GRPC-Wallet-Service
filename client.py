...
class WalletClient(object):
    ...
    def __init__(self, host='0.0.0.0', port=3000):
        ...
        self.stub = wallet_pb2.WalletStub(channel)
    ...
    def encrypt(self, plain_text):
        ...
        '''
        # TODO
        return self.stub.encrypt(wallet_pb2.CardEncryptRequest(card=wallet_pb2.Card(card_holder_name=plain_text['card_holder_name'], card_number=plain_text['card_number'], card_expiry_yyyymm=plain_text['card_expiry_yyyymm'])))
